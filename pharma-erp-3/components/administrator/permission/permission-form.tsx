...
export function PermissionForm({ mode, permission, onSubmit, isLoading, onCancel }: PermissionFormProps) {
  ...
  // Watch moduleName and actionType to auto-generate permission name
  ...
  // Auto-generate permission name when moduleName or actionType changes
  useEffect(() => {
  ...
  // Convert arrays to options format for FormSelect
