...
import { userSchema, UserFormValues } from '../validations';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
         ...
         {mode === 'create' && (
          ...
          <FormInput
            ...
            inputProps={{ type: "text", autoComplete: "employee-id" }}
            disabled={false}
          />
          ...
          <FormInput
            ...
            inputProps={{ type: "tel", autoComplete: "phone" }}
            disabled={false}
          />
          ...
          <FormInput
            ...
            inputProps={{ type: "date", autoComplete: "dob" }}
            disabled={false}
          />
        </div>
