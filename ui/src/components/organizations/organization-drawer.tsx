...
export function OrganizationDrawer({ isOpen, onClose, organization }: OrganizationDrawerProps) {
  const form = useForm<OrganizationFormValues>({
    ...
    defaultValues: {
      ...
      excReginCode: organization?.excReginCode || '',
      stRegnCode: organization?.stRegnCode || '',
      cinNumber: organization?.cinNumber || '',
      interfaceCode: organization?.interfaceCode || '',
      licenseNumber: organization?.licenseNumber || '',
      eccNumber: organization?.eccNumber || '',
      range: organization?.range || '',
      division: organization?.division || '',
      collectorate: organization?.collectorate || '',
